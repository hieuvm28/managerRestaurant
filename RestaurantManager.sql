...
-- Bảng nhân viên
Insert into Employee values ( N'hieuvm', N'000000', N'Vũ Minh Hiếu', 1, '11/28/2000', N'Hà Nội', N'0944572000', 1, getdate(), N'90.jpg')
Insert into Employee values ( N'tungtt', N'000000', N'Trần Thanh Tùng', 0, '05/25/1995', N'Thạch Thất', N'0944572001', 0, getdate(), N'90.jpg')
...
select * from Employee where MaNhanVien = N'hieuvm'
...
join Menu on HoaDonChiTiet.MaMon = Menu.MaMon where HoaDonChiTiet.MaHD = 2 order by HoaDonChiTiet.MaHD DESC


-- Câu này làm report
select HoaDonChiTiet.MaHD, HoaDonChiTiet.MaMon, Menu.TenMon, HoaDon.MaBan, Ban.TenBan, HoaDonChiTiet.SoLuong, HoaDonChiTiet.DonGia,HoaDonChiTiet.SoLuong*HoaDonChiTiet.DonGia as ThanhTien , MaNhanVien, NgayLap, Gio
from Ban join HoaDon on Ban.MaBan = HoaDon.MaBan
join HoaDonChiTiet on HoaDon.MaHD = HoaDonChiTiet.MaHD
join Menu on HoaDonChiTiet.MaMon = Menu.MaMon where HoaDonChiTiet.MaHD = 2 order by HoaDonChiTiet.MaHD DESC
